...
/*
console.log((await (await client.channels.fetch("1216817277958230107"))!.send({
        "files": [
            {
...
export const dataMsg = await (await client.channels.fetch("1216817277958230107") as TextChannel).messages.fetch("1400979476803752057");
